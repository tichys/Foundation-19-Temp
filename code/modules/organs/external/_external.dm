...
/obj/item/organ/external/proc/createwound(var/type = CUT, var/damage, var/surgical)
	...
	if(!surgical && (type in list()) && damage > 150000 && local_damage > 30000)
...
/obj/item/organ/external/proc/droplimb(var/clean, var/disintegrate = DROPLIMB_BLUNT, var/ignore_children, var/silent)
...
/obj/item/organ/external/proc/do_clamp()
	var/rval = 0
