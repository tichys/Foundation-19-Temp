...
/obj/item/clothing/accessory/armorplate
	...
	armor = list(melee = 25, bullet = 70, laser = 30, energy = 10, bomb = 25, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armorplate/tactical
	...
	armor = list(melee = 40, bullet = 85, laser = 60, energy = 35, bomb = 30, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armorplate/merc
	...
	armor = list(melee = 60, bullet = 90, laser = 60, energy = 40, bomb = 40, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armguards/ballistic
	...
	armor = list(melee = 42, bullet = 85, laser = 42, energy = 10, bomb = 25, bio = 0, rad = 0)
